...
<body>
            ...
            <div class="container-fluid"><a class="navbar-brand" href="#">&nbsp;Bitkraft</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation"></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tooltip" data-bs-tooltip="" style="color:#ffffff;" href="index.html"><i class="fas fa-paperclip"></i>&nbsp;</a></li>
                    </ul>
            </div>
    </div>
    </nav>
    ...
    <br>
    <br>
    <form class="search-form" action="invoice.php" method=post >
